...
export function RadialMenu({
  ...
  return (
    <View style={[styles.container, style, { overflow: 'visible' }]} pointerEvents="box-none">
...
function RadialMenuItemComponent({
    ...
    const animatedStyle = useAnimatedStyle(() => {
        ...
        return {
            ...
            opacity: 1, 
            zIndex: 2000, // TEST: Behind Button (3000)
        };
    });

    return (
        <Animated.View style={[styles.menuItem, animatedStyle]}>
            <View style={[styles.menuItemCircle, { backgroundColor: theme.primary }]}>
